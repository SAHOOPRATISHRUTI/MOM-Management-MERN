...
import { addEmployee, listEmployee } from "../../services/api";
...
//   const [itemsPerPage, setItemsPerPage] = useState(5);
  ...
  const fetchEmployees = async (page, searchKey = "") => {
    try {
      ...
      console.log("Employees:",response.data.updatedAt );
  ...
  // Fetch employees when page or searchKey changes
  useEffect(() => {
                      ...
                      <tr key={employee._id}>
                        ...
                        <td className="status">
                          ...
                          <input
                            ...
                            // onChange={() => handleStatusChange(employee._id, !employee.isActive)}
                          />
                        </td>
                      </tr>
                    ))
